...
/* harmony import */ var _foother_foother_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./foother/foother.component */ "./src/app/foother/foother.component.ts");
...
/* harmony import */ var _check_form_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./check-form.service */ "./src/app/check-form.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _foother_foother_component__WEBPACK_IMPORTED_MODULE_11__["FootherComponent"]
        ],
        imports: [
...
let AuthService = class AuthService {
    ...
    registerUser(user) {
        ...
        return this.http.post('account/reg', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
    authUser(user) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('account/auth', user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
...
let FootherComponent = class FootherComponent {
    constructor() { }
    ngOnInit() {
    }
};
FootherComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-foother',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./foother.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/foother/foother.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./foother.component.css */ "./src/app/foother/foother.component.css")).default]
    })
], FootherComponent);
...
module.exports = __webpack_require__(/*! /home/MyFiles/Files/TestAppMean/front-end-app/src/main.ts */"./src/main.ts");
